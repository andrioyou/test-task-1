...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/5tiYDjZMnC)
...
```sh
npx nx serve test-task-1
```

To create a production bundle:

```sh
npx nx build test-task-1
```

To see all available targets to run for a project, run:

```sh
npx nx show project test-task-1
```
